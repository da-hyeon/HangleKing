...
public class Word_Answer_Correct {
    public int nW_x, nW_y ; // 이미지 좌표
    public int sW_x, sW_y ; // 이미지 크기

    public Bitmap Correct; // 이미지
    ...
    // 생성자
    //----------------------------------
    public Word_Answer_Correct(int _x, int _y , Context context){
        ...
        Correct = BitmapFactory.decodeResource(context.getResources(), R.drawable.o);               //이미지생성
        Correct = Bitmap.createScaledBitmap(Correct, sW_x / 2, sW_y / 2 , true);       //크기조정
